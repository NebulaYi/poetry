...
- 五言绝句 26
"""
def generate_samples(model_path='model/final_model', tokenizer_path='vocab/vocab_guwen.txt', prefix='春', length=72, batch_size=1, nsamples=4, temperature=1.0, topk=8, topp=0,
...
"""def main():
    ...
    parser.add_argument('--length', default=5, type=int, required=False, help='生成长度')
    ...
    parser.add_argument('--prefix', default='春', type=str, required=False, help='生成文章的开头')
