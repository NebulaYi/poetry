...
def saveHistoryRecord(email,functionName,question,answer,modeltype,length,style):
    record=Records(email=email,style=style,functionName=functionName,model_type=modeltype,description=question,result=answer,length=length)
    try:
